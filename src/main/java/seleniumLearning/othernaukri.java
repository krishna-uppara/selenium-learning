...
//		driver.manage().window().maximize();
		...
		driver.findElement(By.id("emailTxt")).sendKeys("kuppara1987@gmail.com");
		...
		driver.findElement(By.id("attachCV")).sendKeys("D:\\learning\\seleniumtraining\\src\\resume\\uppara\\krishna_5yrs_Selenium_60Days.docx");
